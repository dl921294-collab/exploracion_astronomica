...
$resultado = $conn->query("SELECT * FROM guias ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <style>
    body { background-color: #0b0d17; color: #e0e6ed; font-family: sans-serif; padding: 20px; }
    ...
    .spec-item { margin: 5px 0; font-size: 0.9em; color: #a0aec0; }
  </style>
</head>
<body>
  <nav>
  ...
  <div class="grid">
    <?php if ($resultado && $resultado->num_rows > 0): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <p style="text-align:center;">No hay guías cargadas todavía.</p>
    <?php endif; ?>
  </div>
</body>
</html>